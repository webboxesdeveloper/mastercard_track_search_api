...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastercardTrackSearchApi.ErrorList();
  });
  ...
  describe('ErrorList', function() {
    it('should create an instance of ErrorList', function() {
      ...
      //var instance = new MastercardTrackSearchApi.ErrorList();
      //expect(instance).to.be.a(MastercardTrackSearchApi.ErrorList);
    });
