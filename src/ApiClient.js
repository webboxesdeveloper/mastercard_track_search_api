...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://sandbox.api.mastercard.com/track/search') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://sandbox.api.mastercard.com/track/search
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://sandbox.api.mastercard.com/track/search",
              'description': "Developer Sandbox",
            },
            {
              'url': "https://api.mastercard.com/track/search",
