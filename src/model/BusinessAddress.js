...
class BusinessAddress {
    ...
    constructor() { 
        ...
        BusinessAddress.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BusinessAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BusinessAddress</code>.
     */
...
/**
 * Street address of Entity to be queried. Alphanumeric characters allowed.
 * @member {String} addressLine1
 */
BusinessAddress.prototype['addressLine1'] = undefined;

/**
 * 3 Character Country Code of Entity to be queried. Alpha characters allowed.
 * @member {String} country
 */
BusinessAddress.prototype['country'] = undefined;

/**
 * State/Province Code of Entity to be queried. Alphanumeric characters allowed.
 * @member {String} countrySubDivision
 */
BusinessAddress.prototype['countrySubDivision'] = undefined;

/**
 * Postal Code of Entity to be queried. Alphanumeric characters allowed as well as spaces, hyphens, and dashes.
 * @member {String} postCode
 */
BusinessAddress.prototype['postCode'] = undefined;

/**
 * City of Entity to be queried. Alphabetical characters allowed as well as periods, dashes, and apostrophes.
 * @member {String} townName
 */
BusinessAddress.prototype['townName'] = undefined;
